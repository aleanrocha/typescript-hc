...
type animals = [string, string, string]

const myAnimals:animals = ['Dog', 'Cat', 'Horse']
...
const pessoa:nameAndAge = ['Zé da Manga', 27]
...
const showNumbers = (numbers: readonly [number, number, number]) => {
  // numbers[0] = 555 
  console.log(numbers)
